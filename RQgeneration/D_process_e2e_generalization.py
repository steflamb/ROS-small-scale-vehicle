...
"""
path_prefix = "/media/ast/1868aaf7-73b4-4e22-9fd8-ff4f3eb47346/ASE/GENERALIZATION/labs_e2e/"
path_suffix = ".bag"
...
for test in ["fail"]:
    ...
    for iteration in ["_obs1","_obs1_generated1","_obs1_generated2"]:
        fig = plt.figure()
        ...
        mixed_path = path_prefix + "mixed/" + test  + str(iteration) + path_suffix
        ...
        if iteration=="_obs1":
            iteration_sim="lap1"
        elif iteration=="_obs1_generated1":
            iteration_sim="lap2"
        else:
            iteration_sim="lap3"
        ...
        plt.savefig(f"PROCESSED RESULTS/RQ5/E2E/plots/{test}_{iteration}.pdf")
...
save_path = Path("PROCESSED RESULTS/RQ5/E2E/aggregated_summary.json")
...
cte_path = Path("/media/ast/1868aaf7-73b4-4e22-9fd8-ff4f3eb47346/ASE/PROCESSED RESULTS/RQ5/E2E/hybrid_trajectory_summary.json")
