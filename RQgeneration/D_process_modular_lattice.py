...
path_prefix = "/media/ast/1868aaf7-73b4-4e22-9fd8-ff4f3eb47346/ASE/MODULAR/LATTICE_PLANNER/"
path_suffix = ".bag"
...
for test in ["green","red"]:
    ...
    for iteration in exp_arrays:
        ...
        plt.savefig(f"PROCESSED RESULTS/RQ3/MODULAR/LATTICE_PLANNER/plots/{test}_{iteration}.pdf")
...
save_path = Path("PROCESSED RESULTS/RQ3/MODULAR/LATTICE_PLANNER/aggregated_summary.json")
...
cte_path = Path("/media/ast/1868aaf7-73b4-4e22-9fd8-ff4f3eb47346/ASE/PROCESSED RESULTS/RQ4/MODULAR/LATTICE_PLANNER/hybrid_trajectory_summary.json")
