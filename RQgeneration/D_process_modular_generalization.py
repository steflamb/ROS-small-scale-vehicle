...
path_prefix = "/media/ast/1868aaf7-73b4-4e22-9fd8-ff4f3eb47346/ASE/GENERALIZATION/labs_modular/"
path_suffix = ".bag"
...
OBSTACLE_OVERRIDES = {
    ...
    "labs": [
        {"x": 33.49906490296618, "y": 42.985505864380734, "yaw": -11.827497766075043},
        {"x": 56.51895336842738, "y": 35.12403322353892, "yaw": -118.51175093473518},
    ],
}
...
for test in ["red"]:
    ...
    mean_dist_sim, mean_dist_mixed, = [], []

    exp_arrays=["success_1","success_2","success_3"]
    ...
    for iteration in exp_arrays:
        ...
        fig = plt.figure()
        path = path_prefix + "real/" + str(iteration) + path_suffix
        ...
        mixed_path = path_prefix + "mixed/" + str(iteration) + path_suffix
        ...
        sim_path = path_prefix + "sim/" + str(iteration_sim) + path_suffix
        ...
        map_path = "/media/ast/1868aaf7-73b4-4e22-9fd8-ff4f3eb47346/ASE/Generalization.json"
        ...
        plt.savefig(f"PROCESSED RESULTS/RQ5/MODULAR/LABS/plots/{test}_{iteration}.pdf")
...
save_path = Path("PROCESSED RESULTS/RQ5/MODULAR/LABS/aggregated_summary.json")
...
for test in averages:
    ...
    obstacle_points = np.array([
        ...
        for obs in OBSTACLE_OVERRIDES["labs"]
    ])
...
cte_path = Path("/media/ast/1868aaf7-73b4-4e22-9fd8-ff4f3eb47346/ASE/PROCESSED RESULTS/RQ5/MODULAR/LABS/hybrid_trajectory_summary.json")
