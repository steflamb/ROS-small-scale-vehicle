    ...
    while not rospy.is_shutdown() and status.is_running:
        ...
        for item in items:
            ...
            if name == "Donkey":
                ...
                x,y,a = for_conversions.real2sim_xyp([translation[0]/1000,translation[1]/1000,math.degrees(rotation[2])])
                obstacles.append(SimPose(name,x,y,translation_z/1000-0.1,a,-89.99,0))
            else:
                x,y,a = for_conversions.real2sim_xyp([translation[0]/1000,translation[1]/1000,math.degrees(rotation[2])])
                obstacles.append(SimPose(name,x,y,translation_z/1000,a,0,0))
